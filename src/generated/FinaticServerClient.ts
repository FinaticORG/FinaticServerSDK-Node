...
export class FinaticServerClient {
  ...
  async getAccounts(page: number = 1, perPage: number = 100, filter?: any): Promise<any> {
    ...
    return await this.brokers.getAccounts(undefined, undefined, undefined, undefined, undefined, perPage, offset, true);
  }
  ...
  async getOrders(page: number = 1, perPage: number = 100, filter?: any): Promise<any> {
    const offset = (page - 1) * perPage;
    return await this.brokers.getOrders(undefined, undefined, undefined, filter?.symbol, filter?.orderStatus, filter?.side, filter?.assetType, perPage, offset, undefined, undefined, true);
  }
  ...
  async getPositions(page: number = 1, perPage: number = 100, filter?: any): Promise<any> {
    const offset = (page - 1) * perPage;
    return await this.brokers.getPositions(undefined, undefined, undefined, filter?.symbol, filter?.side, filter?.assetType, filter?.positionStatus, perPage, offset, undefined, undefined, true);
  }
  ...
  async getBalances(page: number = 1, perPage: number = 100, filter?: any): Promise<any> {
    const offset = (page - 1) * perPage;
    return await this.brokers.getBalances(undefined, undefined, undefined, filter?.isEndOfDaySnapshot, perPage, offset, undefined, undefined, true);
  }
