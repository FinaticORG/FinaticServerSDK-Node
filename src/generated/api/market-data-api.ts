...
export const MarketDataApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getFuturesHistoricalApiV1MarketDataFuturesHistoricalGet: async (symbol: string, startDate?: string | null, endDate?: string | null, expiration?: string | null, provider?: GetFuturesHistoricalApiV1MarketDataFuturesHistoricalGetProviderEnum, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'symbol' is not null or undefined
            assertParamExists('getFuturesHistoricalApiV1MarketDataFuturesHistoricalGet', 'symbol', symbol)
...
export class MarketDataApi extends BaseAPI implements MarketDataApiInterface {
     ...
     * @throws {RequiredError}
     */
    public getFuturesHistoricalApiV1MarketDataFuturesHistoricalGet(requestParameters: MarketDataApiGetFuturesHistoricalApiV1MarketDataFuturesHistoricalGetRequest, options?: RawAxiosRequestConfig) {
        return MarketDataApiFp(this.configuration).getFuturesHistoricalApiV1MarketDataFuturesHistoricalGet(requestParameters.symbol, requestParameters.startDate, requestParameters.endDate, requestParameters.expiration, requestParameters.provider, options).then((request) => request(this.axios, this.basePath));
    }
}
