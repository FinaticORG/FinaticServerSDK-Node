...
export declare const SessionApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    authenticateSessionApiV1SessionAuthenticatePost: (directAuthRequest: DirectAuthRequest, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getSessionUserApiV1SessionSessionIdUserGet: (sessionId: string, companyId: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    linkUserToSessionApiV1SessionLinkUserPost: (sessionId: string, sessionLinkRequest: SessionLinkRequest, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    refreshSessionApiV1SessionRefreshPost: (sessionId: string, companyId: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    testWebhookApiV1SessionWebhookTestPost: (finaticapiApiV1RoutersSessionSessionRouterTestWebhookRequest: FinaticapiApiV1RoutersSessionSessionRouterTestWebhookRequest, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const SessionApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    authenticateSessionApiV1SessionAuthenticatePost(directAuthRequest: DirectAuthRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FinaticResponseTokenData>>;
    /**
     * Get a portal URL with token for a session.  The session must be in ACTIVE or AUTHENTICATING state and the request must come from the same device that initiated the session. Device info is automatically validated from the request.
     * @summary Get Portal Url
     * @param {string} sessionId Session ID
     ...
     * @throws {RequiredError}
     */
    getSessionUserApiV1SessionSessionIdUserGet(sessionId: string, companyId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FinaticResponseSessionUserResponse>>;
    /**
     * Initialize a new session with company API key.
     * @summary Init Session
     * @param {string} xApiKey Company API key
     ...
     * @throws {RequiredError}
     */
    linkUserToSessionApiV1SessionLinkUserPost(sessionId: string, sessionLinkRequest: SessionLinkRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FinaticapiCoreStandardModelsFinaticResponse>>;
    /**
     * Refresh an existing session by extending its expiration time.  This endpoint allows users to extend their session before it expires. The session will be extended by the default duration (24 hours).
     * @summary Refresh Session
     * @param {string} sessionId Session ID to refresh
     ...
     * @throws {RequiredError}
     */
    refreshSessionApiV1SessionRefreshPost(sessionId: string, companyId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FinaticResponseSessionResponseData>>;
    /**
     * Start a session with a one-time token.
     * @summary Start Session
     * @param {string} oneTimeToken
     ...
     * @throws {RequiredError}
     */
    testWebhookApiV1SessionWebhookTestPost(finaticapiApiV1RoutersSessionSessionRouterTestWebhookRequest: FinaticapiApiV1RoutersSessionSessionRouterTestWebhookRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FinaticResponseTestWebhookResponse>>;
};
/**
...
export declare class SessionApi extends BaseAPI implements SessionApiInterface {
     ...
     * @throws {RequiredError}
     */
    authenticateSessionApiV1SessionAuthenticatePost(requestParameters: SessionApiAuthenticateSessionApiV1SessionAuthenticatePostRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<FinaticResponseTokenData, any, {}>>;
    /**
     * Get a portal URL with token for a session.  The session must be in ACTIVE or AUTHENTICATING state and the request must come from the same device that initiated the session. Device info is automatically validated from the request.
     * @summary Get Portal Url
     * @param {SessionApiGetPortalUrlApiV1SessionPortalGetRequest} requestParameters Request parameters.
     ...
     * @throws {RequiredError}
     */
    getPortalUrlApiV1SessionPortalGet(requestParameters: SessionApiGetPortalUrlApiV1SessionPortalGetRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<FinaticResponsePortalUrlResponse, any, {}>>;
    /**
     * Get user information and fresh tokens for a completed session.  This endpoint is designed for server SDKs to retrieve user information and authentication tokens after successful OTP verification.   Security: - Requires valid session in ACTIVE state - Validates device fingerprint binding - Generates fresh tokens (not returning stored ones) - Only accessible to authenticated sessions with user_id
     * @summary Get Session User
     * @param {SessionApiGetSessionUserApiV1SessionSessionIdUserGetRequest} requestParameters Request parameters.
     ...
     * @throws {RequiredError}
     */
    getSessionUserApiV1SessionSessionIdUserGet(requestParameters: SessionApiGetSessionUserApiV1SessionSessionIdUserGetRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<FinaticResponseSessionUserResponse, any, {}>>;
    /**
     * Initialize a new session with company API key.
     * @summary Init Session
     * @param {SessionApiInitSessionApiV1SessionInitPostRequest} requestParameters Request parameters.
     ...
     * @throws {RequiredError}
     */
    initSessionApiV1SessionInitPost(requestParameters: SessionApiInitSessionApiV1SessionInitPostRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<FinaticResponseTokenResponseData, any, {}>>;
    /**
     * Link Supabase user to existing session.  This endpoint is called after successful Supabase OTP authentication to associate the authenticated user with the portal session.
     * @summary Link User To Session
     * @param {SessionApiLinkUserToSessionApiV1SessionLinkUserPostRequest} requestParameters Request parameters.
     ...
     * @throws {RequiredError}
     */
    linkUserToSessionApiV1SessionLinkUserPost(requestParameters: SessionApiLinkUserToSessionApiV1SessionLinkUserPostRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<FinaticapiCoreStandardModelsFinaticResponse, any, {}>>;
    /**
     * Refresh an existing session by extending its expiration time.  This endpoint allows users to extend their session before it expires. The session will be extended by the default duration (24 hours).
     * @summary Refresh Session
     * @param {SessionApiRefreshSessionApiV1SessionRefreshPostRequest} requestParameters Request parameters.
     ...
     * @throws {RequiredError}
     */
    refreshSessionApiV1SessionRefreshPost(requestParameters: SessionApiRefreshSessionApiV1SessionRefreshPostRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<FinaticResponseSessionResponseData, any, {}>>;
    /**
     * Start a session with a one-time token.
     * @summary Start Session
     * @param {SessionApiStartSessionApiV1SessionStartPostRequest} requestParameters Request parameters.
     ...
     * @throws {RequiredError}
     */
    startSessionApiV1SessionStartPost(requestParameters: SessionApiStartSessionApiV1SessionStartPostRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<FinaticResponseSessionResponseData, any, {}>>;
    /**
     * Send a test webhook for the specified event type to the company\'s configured endpoints.
     * @summary Test Webhook
     * @param {SessionApiTestWebhookApiV1SessionWebhookTestPostRequest} requestParameters Request parameters.
     ...
     * @throws {RequiredError}
     */
    testWebhookApiV1SessionWebhookTestPost(requestParameters: SessionApiTestWebhookApiV1SessionWebhookTestPostRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<FinaticResponseTestWebhookResponse, any, {}>>;
}
