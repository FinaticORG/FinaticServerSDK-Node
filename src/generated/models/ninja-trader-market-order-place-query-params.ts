...
export enum NinjaTraderMarketOrderPlaceQueryParamsOrderTypeEnum {
    Market = 'market'
}
export enum NinjaTraderMarketOrderPlaceQueryParamsAssetTypeEnum {
    Equity = 'equity',
    EquityOption = 'equity_option',
    Crypto = 'crypto',
    Forex = 'forex'
}
export enum NinjaTraderMarketOrderPlaceQueryParamsActionEnum {
    Buy = 'buy',
    Sell = 'sell'
}
