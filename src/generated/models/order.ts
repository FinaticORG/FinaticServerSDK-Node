 ...
 */
export type Order =
  | ({ orderType: 'Limit' } & NinjaTraderLimitOrderPlaceQueryParams)
  | ({ orderType: 'Market' } & NinjaTraderMarketOrderPlaceQueryParams)
  | ({ orderType: 'Stop' } & NinjaTraderStopOrderPlaceQueryParams)
  | ({ orderType: 'TrailingStop' } & NinjaTraderTrailingStopOrderPlaceQueryParams);
