 ...
 * @type Order1
 */
export type Order1 = { orderType: 'Limit' } & TastyTradeLimitOrderModifyQueryParams | { orderType: 'Market' } & TastyTradeMarketOrderModifyQueryParams | { orderType: 'Stop' } & TastyTradeStopOrderModifyQueryParams | { orderType: 'TrailingStop' } & TastyTradeTrailingStopOrderModifyQueryParams;
