 ...
 * @type Order2
 */
export type Order2 = { orderType: 'Limit' } & TastyTradeLimitOrderPlaceQueryParams | { orderType: 'Market' } & TastyTradeMarketOrderPlaceQueryParams | { orderType: 'Stop' } & TastyTradeStopOrderPlaceQueryParams | { orderType: 'TrailingStop' } & TastyTradeTrailingStopOrderPlaceQueryParams;
