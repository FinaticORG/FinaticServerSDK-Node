 ...
 */
export type Order3 =
  | ({ orderType: 'Limit' } & NinjaTraderLimitOrderModifyQueryParams)
  | ({ orderType: 'Market' } & NinjaTraderMarketOrderModifyQueryParams)
  | ({ orderType: 'Stop' } & NinjaTraderStopOrderModifyQueryParams)
  | ({ orderType: 'TrailingStop' } & NinjaTraderTrailingStopOrderModifyQueryParams);
