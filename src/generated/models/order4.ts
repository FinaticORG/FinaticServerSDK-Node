 ...
 */
export type Order4 =
  | ({ orderType: 'Limit' } & TastyTradeLimitOrderModifyQueryParams)
  | ({ orderType: 'Market' } & TastyTradeMarketOrderModifyQueryParams)
  | ({ orderType: 'Stop' } & TastyTradeStopOrderModifyQueryParams)
  | ({ orderType: 'TrailingStop' } & TastyTradeTrailingStopOrderModifyQueryParams);
