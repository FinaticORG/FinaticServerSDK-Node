 ...
 * @type Order5
 */
export type Order5 = { orderType: 'Limit' } & LimitOrderModifyQueryParams | { orderType: 'Market' } & MarketOrderModifyQueryParams | { orderType: 'Stop' } & StopOrderModifyQueryParams | { orderType: 'TrailingStop' } & TrailingStopOrderModifyQueryParams;
