 ...
 */
export interface StopOrderPlaceQueryParams {
    'accountNumber': Accountnumber;
    'orderType': StopOrderPlaceQueryParamsOrderTypeEnum;
    'assetType': PublicAssetTypeEnum;
    'action': StopOrderPlaceQueryParamsActionEnum;
...
export enum StopOrderPlaceQueryParamsOrderTypeEnum {
    Stop = 'Stop'
}
export enum StopOrderPlaceQueryParamsActionEnum {
    Buy = 'Buy',
    Sell = 'Sell',
