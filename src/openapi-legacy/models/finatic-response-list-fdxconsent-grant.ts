...
// @ts-ignore
import type { SuccessPayloadListFDXConsentGrant } from './success-payload-list-fdxconsent-grant';

export interface FinaticResponseListFDXConsentGrant {
    /**
     ...
     */
    'success'?: SuccessPayloadListFDXConsentGrant | null;
    /**
