...
export const BrokersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getTransactionsApiBetaBrokersDataTransactionsGet: async (brokerId?: string | null, connectionId?: string | null, accountId?: string | null, unitCode?: string | null, currency?: string | null, transactionType?: string | null, startDate?: string | null, endDate?: string | null, limit?: number, offset?: number, beforeTransactionDate?: string | null, beforeTransactionId?: string | null, includeRawPayload?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            if (beforeTransactionDate !== undefined) {
                localVarQueryParameter['before_transaction_date'] = (beforeTransactionDate as any instanceof Date) ?
...
export const BrokersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getTransactionsApiBetaBrokersDataTransactionsGet(brokerId?: string | null, connectionId?: string | null, accountId?: string | null, unitCode?: string | null, currency?: string | null, transactionType?: string | null, startDate?: string | null, endDate?: string | null, limit?: number, offset?: number, beforeTransactionDate?: string | null, beforeTransactionId?: string | null, includeRawPayload?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FinaticResponseListFDXBrokerTransaction>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getTransactionsApiBetaBrokersDataTransactionsGet(brokerId, connectionId, accountId, unitCode, currency, transactionType, startDate, endDate, limit, offset, beforeTransactionDate, beforeTransactionId, includeRawPayload, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
