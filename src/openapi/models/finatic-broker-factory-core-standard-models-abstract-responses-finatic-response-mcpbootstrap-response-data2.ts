...
// @ts-ignore
import type { SuccessPayloadMCPBootstrapResponseData } from './success-payload-mcpbootstrap-response-data';

export interface FinaticBrokerFactoryCoreStandardModelsAbstractResponsesFinaticResponseMCPBootstrapResponseData2 {
    /**
     ...
     */
    'success'?: SuccessPayloadMCPBootstrapResponseData | null;
    /**
