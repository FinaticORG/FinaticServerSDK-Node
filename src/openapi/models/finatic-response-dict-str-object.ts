...
// @ts-ignore
import type { SuccessPayloadDictStrObject } from './success-payload-dict-str-object';

export interface FinaticResponseDictStrObject {
  /**
   ...
   */
  success?: SuccessPayloadDictStrObject | null;
  /**
