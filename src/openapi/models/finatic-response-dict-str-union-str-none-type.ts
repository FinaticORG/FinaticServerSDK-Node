...
// @ts-ignore
import type { SuccessPayloadDictStrUnionStrNoneType } from './success-payload-dict-str-union-str-none-type';

export interface FinaticResponseDictStrUnionStrNoneType {
  /**
   ...
   */
  success?: SuccessPayloadDictStrUnionStrNoneType | null;
  /**
