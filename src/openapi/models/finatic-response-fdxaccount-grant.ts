...
// @ts-ignore
import type { SuccessPayloadFDXAccountGrant } from './success-payload-fdxaccount-grant';

export interface FinaticResponseFDXAccountGrant {
    /**
     ...
     */
    'success'?: SuccessPayloadFDXAccountGrant | null;
    /**
