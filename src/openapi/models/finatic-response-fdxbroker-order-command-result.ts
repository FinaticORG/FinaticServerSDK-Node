...
// @ts-ignore
import type { SuccessPayloadFDXBrokerOrderCommandResult } from './success-payload-fdxbroker-order-command-result';

export interface FinaticResponseFDXBrokerOrderCommandResult {
    /**
     ...
     */
    'success'?: SuccessPayloadFDXBrokerOrderCommandResult | null;
    /**
