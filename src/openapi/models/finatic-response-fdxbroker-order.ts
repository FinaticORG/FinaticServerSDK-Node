...
// @ts-ignore
import type { SuccessPayloadFDXBrokerOrder } from './success-payload-fdxbroker-order';

export interface FinaticResponseFDXBrokerOrder {
  /**
   ...
   */
  success?: SuccessPayloadFDXBrokerOrder | null;
  /**
