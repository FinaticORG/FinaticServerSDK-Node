...
// @ts-ignore
import type { SuccessPayloadFDXConsentGrant } from './success-payload-fdxconsent-grant';

export interface FinaticResponseFDXConsentGrant {
    /**
     ...
     */
    'success'?: SuccessPayloadFDXConsentGrant | null;
    /**
