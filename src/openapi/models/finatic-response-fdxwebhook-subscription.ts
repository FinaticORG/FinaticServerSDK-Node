...
// @ts-ignore
import type { SuccessPayloadFDXWebhookSubscription } from './success-payload-fdxwebhook-subscription';

export interface FinaticResponseFDXWebhookSubscription {
    /**
     ...
     */
    'success'?: SuccessPayloadFDXWebhookSubscription | null;
    /**
