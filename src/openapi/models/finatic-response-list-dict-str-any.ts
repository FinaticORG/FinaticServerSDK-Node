...
// @ts-ignore
import type { SuccessPayloadListDictStrAny } from './success-payload-list-dict-str-any';

export interface FinaticResponseListDictStrAny {
    /**
     ...
     */
    'success'?: SuccessPayloadListDictStrAny | null;
    /**
