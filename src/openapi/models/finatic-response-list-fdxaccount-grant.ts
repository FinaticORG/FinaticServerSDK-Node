...
// @ts-ignore
import type { SuccessPayloadListFDXAccountGrant } from './success-payload-list-fdxaccount-grant';

export interface FinaticResponseListFDXAccountGrant {
  /**
   ...
   */
  success?: SuccessPayloadListFDXAccountGrant | null;
  /**
