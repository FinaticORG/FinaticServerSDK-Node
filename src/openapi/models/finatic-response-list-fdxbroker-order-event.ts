...
// @ts-ignore
import type { SuccessPayloadListFDXBrokerOrderEvent } from './success-payload-list-fdxbroker-order-event';

export interface FinaticResponseListFDXBrokerOrderEvent {
    /**
     ...
     */
    'success'?: SuccessPayloadListFDXBrokerOrderEvent | null;
    /**
