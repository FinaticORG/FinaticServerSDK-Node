...
// @ts-ignore
import type { SuccessPayloadListFDXBrokerOrderGroup } from './success-payload-list-fdxbroker-order-group';

export interface FinaticResponseListFDXBrokerOrderGroup {
  /**
   ...
   */
  success?: SuccessPayloadListFDXBrokerOrderGroup | null;
  /**
