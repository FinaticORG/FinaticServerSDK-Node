...
// @ts-ignore
import type { SuccessPayloadSessionSyncStatusResponse } from './success-payload-session-sync-status-response';

export interface FinaticResponseSessionSyncStatusResponse {
    /**
     ...
     */
    'success'?: SuccessPayloadSessionSyncStatusResponse | null;
    /**
