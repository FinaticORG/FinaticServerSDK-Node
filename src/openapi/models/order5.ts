 ...
 */
export type Order5 =
  | ({ orderType: 'limit' } & Trading212LimitOrderPlaceQueryParams)
  | ({ orderType: 'market' } & Trading212MarketOrderPlaceQueryParams)
  | ({ orderType: 'stop' } & Trading212StopOrderPlaceQueryParams)
  | ({ orderType: 'stop_limit' } & Trading212StopLimitOrderPlaceQueryParams);
