 ...
 * @type Order7
 */
export type Order7 = { orderType: 'limit' } & WebullLimitOrderModifyQueryParams | { orderType: 'market' } & WebullMarketOrderModifyQueryParams | { orderType: 'stop' } & WebullStopOrderModifyQueryParams | { orderType: 'trailing_stop' } & WebullTrailingStopOrderModifyQueryParams;
